...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr_D', default=1e-4, type=float, help='learning rate for training the discriminator')
    ...
    parser.add_argument('--print_iter', default=500, type=int, help='print losse iter')

    parser.add_argument('--ckpt_dir', default='checkpoints', type=str, help='checkpoint directory')
    parser.add_argument('--ckpt_load', default=None, type=str, help='checkpoint name to load')
    parser.add_argument('--ckpt_save_iter', default=5000, type=int, help='checkpoint save iter')
